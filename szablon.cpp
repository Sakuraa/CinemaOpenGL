...
void windowInit()
{
	...
	diffuseLight1[0] = 1.0f;
	diffuseLight1[1] = 0.5f;
	diffuseLight1[2] = 1.0f;
	...
	lightPos1[0] = kameraX+1;
	lightPos1[1] = kameraY+1;
	lightPos1[2] = kameraZ;
	lightPos1[3] = 0.5f;
	
	spotDirectionLight1[0] = 1.0f;
	spotDirectionLight1[1] = 1.0f;
	spotDirectionLight1[2] = 1.0f;
	...
	glLightf(GL_LIGHT1,GL_SPOT_CUTOFF,5.0); //promien swiatla
